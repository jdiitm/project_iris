...
See [TESTING.md](TESTING.md) for authoritative test counts and suite details. All tests passing.
...
- [x] Test Suite Passing (all TLS-enabled; see [TESTING.md](TESTING.md) for counts)
